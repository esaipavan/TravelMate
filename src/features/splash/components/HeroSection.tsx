...
export function HeroSection() {
  ...
  return (
    <>
      ...
      <section
        id="main-content"
        className="relative min-h-[88vh] overflow-hidden lg:hidden"
        aria-label="Hero"
      >
        <motion.div
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 pt-20">
          ...
          <p className="mb-7 text-[15px] leading-relaxed text-white/75">
            AI itinerary, budget tracking, and travel companion — all in one app, completely free.
          </p>
          <Link
            to="/register"
          ...
          <p className="text-center text-[12px] text-white/55">
            No card needed · Sign in with Google · 500+ trips planned
          </p>
        </div>
      </section>
      ...
      <section
        id="main-content"
        className="relative hidden min-h-screen items-center overflow-hidden lg:flex"
        aria-label="Hero"
        style={{ background: 'linear-gradient(135deg, #EFF6FF 0%, #FAFAF7 60%)' }}
      >
        <div className="mx-auto flex w-full max-w-6xl flex-1 items-center gap-16 px-8 py-28">
          ...
          >
            ...
            <motion.h1
              custom={1}
              variants={variants}
              className="mb-5 text-[60px] font-extrabold leading-[1.08] tracking-[-0.03em] text-gray-900"
            >
              Plan your best trips.
            </motion.h1>
            <motion.p
              custom={2}
              variants={variants}
              className="mb-8 max-w-lg text-[18px] leading-[1.65] text-gray-500"
            >
              AI itinerary, budget tracking, and travel companion — all in one app, completely free.
            </motion.p>
            <motion.div
            ...
            >
              ...
              <a
                href="#preview"
                className="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-7 py-3.5 text-[16px] font-medium text-gray-600 transition-all hover:border-gray-300 hover:text-gray-900"
              >
                See how it works
              </a>
            </motion.div>
            <motion.div
              custom={4}
              variants={variants}
              className="flex flex-wrap items-center gap-5 text-[13px] text-gray-400"
            >
      ...
      <div className="flex items-center justify-between px-6 pb-2 pt-5">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="ml-1.5 h-3 w-6 rounded-sm border border-white/30 p-0.5">
            <div className="rounded-xs h-full w-3/4 bg-white/50" />
          </div>
        </div>
      </div>
