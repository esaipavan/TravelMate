...
import { TRAIN_CLASSES, TRAIN_CLASS_LABEL } from '../types';
...
interface Props {
  ...
  onClassChange: (v: TrainClass) => void;
  onSearch: () => void;
  isLoading?: boolean;
}
  ...
  return (
    <div className="flex flex-col gap-2 rounded-2xl border border-border/60 bg-card p-2">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          ...
          <Input
            ...
            placeholder="From"
            aria-label="From station or city"
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <select
          value={travelClass}
          onChange={(e) => onClassChange(e.target.value as TrainClass)}
