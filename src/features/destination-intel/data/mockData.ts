...
const BALI: DestinationData = {
  ...
  insights: [
    ...
    },
    {
      ...
      body: 'A sarong and sash are required at temples like Tanah Lot and Uluwatu — most temples rent them cheaply at the entrance if you forget your own.',
      emoji: '🛕',
      category: 'culture',
      priority: 'medium',
    },
    {
      id: 'b4',
      title: 'Warung over Restaurant',
      body: 'Local warungs serve better, cheaper Balinese food than tourist restaurants — look for nasi campur or babi guling stalls with a local crowd.',
      emoji: '🍚',
      category: 'food',
      priority: 'medium',
    },
...
const BANGKOK: DestinationData = {
  ...
  insights: [
    ...
    },
    {
      ...
      body: 'Shoulders and knees must be covered at Wat Phra Kaew and other major temples — sarongs are available for rent at most entrances.',
      emoji: '🙏',
      category: 'culture',
      priority: 'medium',
    },
    {
      ...
      body: 'Pick street food stalls with a long local queue and high turnover — freshly cooked over high heat is generally the safest bet.',
      emoji: '🍜',
      category: 'food',
      priority: 'medium',
    },
...
const TOKYO: DestinationData = {
  ...
  insights: [
    ...
    },
    {
      ...
      body: 'Despite the tech reputation, many small restaurants and shops remain cash-only — carry yen, especially outside major stations.',
      emoji: '💴',
      category: 'culture',
      priority: 'medium',
    },
    {
      id: 't4',
      title: 'Konbini Meals',
      body: "Don't skip convenience stores — 7-Eleven, Lawson, and FamilyMart onigiri and bento are genuinely excellent, cheap, and everywhere.",
      emoji: '🍙',
      category: 'food',
      priority: 'medium',
    },
...
const PARIS: DestinationData = {
  ...
  insights: [
    ...
    {
      id: 'p3',
      title: 'Say Bonjour First',
      body: 'Always greet with "Bonjour" before starting a conversation in a shop or café — skipping it is considered genuinely impolite.',
      emoji: '👋',
      category: 'culture',
      priority: 'medium',
    },
    {
      id: 'p4',
      title: 'Museum Pass Math',
      body: 'The Paris Museum Pass pays for itself after 3-4 major sights and lets you skip most standard ticket lines.',
      emoji: '🎟',
      category: 'money',
      priority: 'medium',
    },
...
const DUBAI: DestinationData = {
  ...
  insights: [
    ...
    {
      id: 'd3',
      title: 'Modest Dress in Public',
      body: 'Cover shoulders and knees in malls, markets, and public areas outside beach resorts — it is genuinely expected, not just polite.',
      emoji: '🧕',
      category: 'culture',
      priority: 'medium',
    },
    {
      ...
      body: 'If visiting during Ramadan, avoid eating or drinking in public during daylight hours out of respect for those fasting.',
      emoji: '🌙',
      category: 'safety',
      priority: 'medium',
    },
...
const LONDON: DestinationData = {
  ...
  insights: [
    ...
    {
      id: 'l3',
      title: 'Stand Right, Walk Left',
      body: 'Always stand on the right side of Underground escalators to let people pass on the left — it is a strictly observed local rule.',
      emoji: '🚇',
      category: 'culture',
      priority: 'medium',
    },
    {
      id: 'l4',
      title: 'Same-Day Theatre Tickets',
      body: 'The TKTS booth in Leicester Square sells genuine same-day West End tickets at a discount — worth checking before paying full price online.',
      emoji: '🎭',
      category: 'timing',
      priority: 'medium',
    },
